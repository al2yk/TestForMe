...
import com.example.testforme.presentation.screens.singup.TextFieldSignUPPass

@Composable
fun SignInView(controller: NavHostController) {
    ...
    )
    {
        ...
        Button(onClick = { ViewModel.SignUp(controller) })
        { Text("Войти") }
    }
